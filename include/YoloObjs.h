...
namespace yolo {
    ...
    struct DrawParam {
        ...
        int rbox_line_width = 2;
        int mask_line_width = 1;
        float mask_alpha    = 0.5f;
        int kpt_line_width  = 2;
        int kpt_radius      = 5;
        KptPairs kpt_pairs  =
                              {{0, 1}, {0, 2}, {1, 2}, {1, 3}, {2, 4},
        ...
        KptPairColors
        kpt_pair_colors     = {cv::Scalar(0, 0, 250), cv::Scalar(0, 0, 250), cv::Scalar(0, 0, 250), cv::Scalar(0, 0, 250), cv::Scalar(0, 0, 250),
                               cv::Scalar(220,  0, 250), cv::Scalar(220,  0, 250), cv::Scalar(220,  0, 250), cv::Scalar(220,  0, 250), cv::Scalar(220,  0, 250), cv::Scalar(220,  0, 250),
                               cv::Scalar(110,  250, 0), cv::Scalar(110,  250, 0), cv::Scalar(110,  250, 0),
                               cv::Scalar(0, 255, 250), cv::Scalar(0, 255, 250), cv::Scalar(0, 255, 250), cv::Scalar(0, 255, 250), cv::Scalar(0, 255, 250)};
        int track_line_width = 1;
        int loc_radius       = 4;
        cv::Scalar
        ...
        float scale          = 1.0f;
        std::unordered_map<std::string, cv::Scalar>
        label_colors         = {};  // override marker color per label (BGR).
                                    // e.g. {{"person", {0,255,0}}, {"car", {255,255,255}}, {"traffic sign", {0,165,255}}}
                                    // Empty = use default 48-color palette.
    };
